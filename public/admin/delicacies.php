...
<head>
    ...
    <title>Delicacies Management</title>
</head>
<body>
        ...
        <div class="container">
            ...
            <?php if ($action === "list"): ?>
                <div class="admin-header">
                    <h2>Delicacies Management</h2>
                    <a href="?action=add" class="btn btn-primary btn-square">+ Add Delicacies</a>
                </div>
            ...
            <?php elseif ($action === "add" || $action === "edit"): ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea required type="text" name="ingredients" id="ingredients" class="form-textarea"> <?= $formData ? htmlspecialchars_decode($formData['ingredients']) : "" ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="instructions" class="form-label">Instructions</label>
                        <textarea required type="text" name="instructions" id="instructions" class="form-textarea"> <?= $formData ? htmlspecialchars_decode($formData['instructions']) : "" ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="image" class="form-label">Image</label>
                        <input type="file" name="image" id="image" class="form-input" accept="image/*">
                        <img id="imagePreview" class="image-preview" src="<?= "../../uploads/$table/" . $formData['image_name'] ?>" alt="Image Preview">
                     </div>
