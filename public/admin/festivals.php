        ...
        <div class="container">
            ...
            <?php if ($action === "list"): ?>
                <div class="admin-header">
                    <h2>Festivals Management</h2>
                    <a href="?action=add" class="btn btn-primary btn-square">+ Add Festivals</a>
                </div>
            ...
            <?php elseif ($action === "add" || $action === "edit"): ?>
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea required type="text" name="history" id="history" class="form-textarea"> <?= $formData ? htmlspecialchars_decode($formData['history']) : "" ?></textarea>
                    </div>
